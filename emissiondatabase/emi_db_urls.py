...
router.register(r'emissioncategory',EmissionCategoryViewSet, basename='emissiocategory')
router.register(r'emissionfactor',EmissionFactorViewSet, basename='emissionfactor')
router.register(r'geographicalscope',GeographicalScopelViewSet, basename='geographicalscope')
router.register(r'datasource',DataSourceViewSet, basename='datasource')
router.register(r'juncContribEmit',JunctionContributorEmissionfactorViewSet,basename='junction')
